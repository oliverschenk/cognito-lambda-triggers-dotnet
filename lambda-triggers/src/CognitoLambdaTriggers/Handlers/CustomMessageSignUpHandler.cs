...
internal class CustomMessageSignUpHandler : CognitoTriggerHandler<CustomMessageEvent>
{
    public const string TRIGGER_SOURCE = "CustomMessage_SignUp";

    public override string TriggerSource => TRIGGER_SOURCE;

    public CustomMessageSignUpHandler(JsonElement cognitoEvent, ILambdaLogger logger)
