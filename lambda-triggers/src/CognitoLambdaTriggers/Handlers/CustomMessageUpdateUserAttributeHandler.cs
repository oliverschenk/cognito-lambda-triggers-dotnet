...
internal class CustomMessageUpdateUserAttributeHandler : CognitoTriggerHandler<CustomMessageEvent>
{
    public const string TRIGGER_SOURCE = "CustomMessage_UpdateUserAttribute";

    public override string TriggerSource => TRIGGER_SOURCE;

    public CustomMessageUpdateUserAttributeHandler(JsonElement cognitoEvent, ILambdaLogger logger)
