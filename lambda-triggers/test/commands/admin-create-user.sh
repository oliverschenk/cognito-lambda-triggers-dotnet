...
function usage {
    echo ""
    echo "DESCRIPTION:"
    echo "  Creates a random user in a Cognito User Pool using AdminCreateUser API."
    ...
    echo ""
    echo "USAGE:"
    echo "  admin-create-user.sh <COGNITO_USER_POOL_ID> <BASE_EMAIL_ADDRESS>"
}
